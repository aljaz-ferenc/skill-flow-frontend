...
export async function generateLesson(body: {
  ...
  try {
    ...
    const res = await fetch(Endpoints.lesson, {
      method: "POST",
      headers: {
...
export async function checkAnswer(payload: {
  ...
  try {
    const res = await fetch(Endpoints.checkAnswer, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function generateRoadmap(topic: string) {
  try {
    const res = await fetch(Endpoints.generateRoadmap, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function planLessons(payload: {
  ...
  try {
    const res = await fetch(Endpoints.planLessons, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
